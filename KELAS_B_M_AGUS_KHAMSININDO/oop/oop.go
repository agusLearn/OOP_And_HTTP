...
func (d *Document) Progress() { d.SetState(d.GetStateFromMap("completed")) }
func (d *Document) Submit()   { d.SetState(d.GetStateFromMap("submitted")) }
func (d *Document) Approve()  { d.SetState(d.GetStateFromMap("approved")) }
func (d *Document) Reject()   { d.SetState(d.GetStateFromMap("rejected")) }
func (d *Document) Publish()  { d.SetState(d.GetStateFromMap("published")) }
